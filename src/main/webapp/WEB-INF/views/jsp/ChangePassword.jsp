   ...
   <div class="row">
    <div class="col-md-6 col-sm-8">
      <div class="common-form form2">
        <form action="changePasswordpage" method="post" id="SetTpinPasswordform" novalidate="novalidate">
          ...
          <div class="row justify-content-center set-pr">
            <div class="col-md-9">
              <div class="mb-2 d-grid gap-2">
                <button type="submit" class="btn btn-primary btn-lg blue-btn set-btn">Set <strong>Password</strong> </button>
              </div>
            </div>
          </div>
