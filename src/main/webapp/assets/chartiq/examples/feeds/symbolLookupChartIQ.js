...
CIQ.ChartEngine.Driver.Lookup.ChartIQ = function (exchanges) {
	...
	this.url ="http://localhost:8089/market-watch/symbolLookupService";
		//UAT: "http://crypo.enrichbroking.com:8080/market-watch/symbolLookupService"
		
		//"http://localhost:8089/market-watch/symbolLookupService";
		//"http://crypo.enrichbroking.com:8080/market-watch/symbolLookupService";
...
CIQ.ChartEngine.Driver.Lookup.ChartIQ.prototype.acceptText = function (
	...
	var url =
		this.url + "?t=" + encodeURIComponent(text) + "&m=" + maxResults + "&e=" + filter;
