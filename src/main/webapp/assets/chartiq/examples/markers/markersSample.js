...
if (
	...
	_css = require("../../assets/chartiq/examples/markers/markersSample.css");
else if (typeof define === "function" && define.amd)
	define(["../../assets/chartiq/examples/markers/markersSample.css"], function (m) {
		_css = m;
	});
else if (typeof window !== "undefined")
	CIQ.loadStylesheet("assets/chartiq/examples/markers/markersSample.css");
