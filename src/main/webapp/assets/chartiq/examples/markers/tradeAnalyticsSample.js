...
if (
	...
	_css = require("../../assets/chartiq/examples/markers/tradeAnalyticsSample.css");
else if (typeof define === "function" && define.amd)
	define(["../../assets/chartiq/examples/markers/tradeAnalyticsSample.css"], function (m) {
		_css = m;
	});
else if (typeof window !== "undefined")
	CIQ.loadStylesheet("assets/chartiq/examples/markers/tradeAnalyticsSample.css");
